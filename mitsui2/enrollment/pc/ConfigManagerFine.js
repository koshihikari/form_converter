...
jQuery(document).ready(function($){
	...
	MYNAMESPACE.namespace('model.ConfigFineManager');
	MYNAMESPACE.model.ConfigFineManager = function() {
		this.initialize.apply(this, arguments);
	};
	MYNAMESPACE.model.ConfigFineManager.prototype = {
		 _instances			: {}
		 ,_classname		: []
		 ,_idname			: []
		 ,_Validation		: {}
...
/*	ファインコート	*/	,keikaku_kodate_yosan	: "chkselect0"
/*	ファインコート	*/	,keikaku_kodate_menseki	: "chkselect0"
/*	ファインコート	*/	,keikaku_kodate_tochi	: "chkselect0"
